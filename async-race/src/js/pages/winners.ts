...
export class Winners extends BaseComponent {
  ...
  constructor() {
    ...
    this.section.append(
      this.countWin.counter,
      this.countPage.counter,
      this.tableWinners.element
    );
  ...
  getMarkup() {
    ...
    this.tableWinners.tBody.insertAdjacentHTML(
      "afterbegin",
      this.renderWinners()
    );
  }
  ...
  addListeners() {
    this.listenerForSortBy(
      this.tableWinners.thId.element,
      "Number",
      `id`,
      `DESC`
    );
    this.listenerForSortBy(
      this.tableWinners.thWins.element,
      "Wins",
      `wins`,
      `DESC`
    );
    this.listenerForSortBy(
      this.tableWinners.thTime.element,
      "Best time (seconds)",
      `time`,
      `DESC`
    );
